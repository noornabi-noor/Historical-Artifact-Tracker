...
//       {/* Search Form */}
//       <form onSubmit={handleSearch} className="flex justify-center mb-6 relative z-10">
//         <input
//           type="text"
//           value={searchText}
...
<<<<<<< HEAD
              ...
              <th className="border border-gray-300 py-3 px-4 text-left text-sm font-semibold text-gray-700">Context</th>
