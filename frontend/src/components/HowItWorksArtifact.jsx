...
const steps = [
  {
    ...
    description:
      "Register to start tracking and contributing historical artifacts worldwide.",
  },
  {
    icon: (
      <FaSearchLocation className="text-3xl text-white dark:text-gray-100" />
    ),
    title: "Explore Artifacts",
    description:
      "Browse and discover artifacts by region, era, or cultural significance.",
  },
  {
    icon: <FaUpload className="text-3xl text-white dark:text-gray-100" />,
    title: "Upload & Track",
    description:
      "Add new artifacts with metadata and track changes in their condition or location.",
  },
  {
    icon: <FaBookOpen className="text-3xl text-white dark:text-gray-100" />,
    title: "Learn & Share",
    description:
      "Access detailed historical context and contribute your knowledge to the community.",
  },
];
